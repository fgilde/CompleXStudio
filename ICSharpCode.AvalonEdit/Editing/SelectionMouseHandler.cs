...
namespace ICSharpCode.AvalonEdit.Editing
{
	...
	public sealed class SelectionMouseHandler : ITextAreaInputHandler
	{
        ...
        {
            return GetWordAtMousePosition(e, textArea.TextView);
        }

		public static SimpleSegment GetWordAtMousePosition(MouseEventArgs e,TextView textView)
		{
			Point pos = e.GetPosition(textView);
		    return GetWordAtMousePosition(pos, textView);
		}


        public static SimpleSegment GetWordAtMousePosition(Point pos, TextView textView)
        {
