...
namespace ICSharpCode.AvalonEdit
{
	...
	public static class AvalonEditCommands
	{
		...
		/// The default shortcut is Ctrl+D. but we want to duplicate with ctrl+d
		/// </summary>
        ...
        /// Duplicates the line
        /// </summary>
        public static readonly RoutedCommand DuplicateLine = new RoutedCommand(
            "DuplicateLine", typeof(TextEditor),
            new InputGestureCollection {
