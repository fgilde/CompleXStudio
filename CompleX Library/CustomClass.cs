...
using CompleX_Library.Controls;
...
namespace CompleX_Library
{
    ...
    public class CustomClass : Component, ICustomTypeDescriptor
    {
        ...
        public PropertyDescriptor AddProperty(string propName, object propValue, string propDesc,
                       string propCat, Type propType)
        {
        ...
        {
            DynamicProperty property = new DynamicProperty(propName, propValue, propDesc, propCat,
                                                           propType, false, false,
                                                           new EditorAttribute(typeof(T), typeof(UITypeEditor)));
        ...
        /// </summary>
        public PropertyDescriptor AddProperty(string propName, object propValue, string propDesc, 
                               string propCat,  System.Type propType, bool isReadOnly, bool isExpandable, params string[] possibleValues)
        {
            DynamicProperty property;
            if(possibleValues.Count() >0)
            {
                // bei liste mit möglichen werten, einen entsprechenden editor bereitstellen
                property = new DynamicProperty(propName, propValue, propDesc, propCat,
                            propType, isReadOnly, isExpandable,
                            new EditorAttribute(typeof(EnumerableStringSelector), typeof(UITypeEditor))
                            );
        ...
        public class DynamicProperty : PropertyDescriptor
        {
            ...
            public DynamicProperty(string pName, object pValue, string pDesc, string pCat, Type pType, bool readOnly, bool expandable, params Attribute[] attrs)
                : base(pName, attrs)
            {
                propName        = pName;
                propValue		= pValue;
